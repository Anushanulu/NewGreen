...
public class ResponseCreation_copy {
...
private WebDriver driver;
	...
	//Adding response details
		...
		@FindBy (xpath="//button[@class='_hj-OO1S1__styles__openStateToggle']//span") private WebElement alertminimize;
		//@FindBy(xpath = "//button[@class='_hj-OO1S1__styles__openStateToggle']//span") private WebElement feedback_PopUp;
	...
	//Response attributes
		...
		@FindBy ( xpath="//input[@ng-reflect-name='expectedStartDate']") private WebElement Startdt_Field ;
	...
	//Submit response
		...
		public ResponseCreation_copy(WebDriver driver)
		{
			this.driver=driver;
